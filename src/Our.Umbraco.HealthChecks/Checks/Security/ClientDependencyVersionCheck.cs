...
namespace Our.Umbraco.HealthChecks.Checks.Security
{
    ...
    public class ClientDependencyVersionCheck : HealthCheck
    {
        ...
        private const string MinimumVersionNumber = "1.9.7";

        public ClientDependencyVersionCheck(HealthCheckContext healthCheckContext) : base(healthCheckContext)
        {
        ...
        public HealthCheckStatus CheckClientDependencyVersion()
        {
            ...
            string message = success ? TextService.Localize("Our.Umbraco.HealthChecks/clientDependencyVersionCheckSuccess") : TextService.Localize("Our.Umbraco.HealthChecks/clientDependencyVersionCheckError");
